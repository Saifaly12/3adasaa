...
@Component({
  selector: 'app-all-articles-component',
  imports: [],
...
export class AllArticlesComponent {
  posts = [
    ...
    },
    {
      ...
      readTime: '9 دقائق للقراءة',
      featured: false,
      tags: ['تصوير معماري', 'مباني', 'عمارة'],
    },
  ];
  categories: Category[] = [
    { name: 'إضاءة', count: 3, icon: 'fa-solid fa-gear' },
